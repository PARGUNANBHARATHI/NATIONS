      ...
      <div className="about">
        <div className="about-paragraph">
          ...
          <p><FcAbout />Bharat's culture is its lifeblood — a timeless source of identity, unity, and strength.
            ...
            merely be a geographical expression<br></br>Not the true Bharat-India we have always genuinely loved and passionately revered.<br></br>
          </p>
          ...
          <p><FcAbout />Geographical boundaries alone do not define a nation. It is the shared values<br></br>
            ...
            <br></br> No force can possibly undermine our timeless honor or our rich heritage.</p>
          ...
          <p><FcAbout />It is the responsibility of every individual to contribute to the strengthening <br></br>and
            ...
            and ensure that <br></br>Our glorious legacy lives on with pride for future generations to come.
